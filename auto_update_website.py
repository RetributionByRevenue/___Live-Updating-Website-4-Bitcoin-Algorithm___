...
<table role="table">
  ...
  <tbody role="rowgroup">
    <tr role="row">
      <td role="cell"><p><font color="white">
'''
end_html=''' 
      </font></p></td>
      <td role="cell"><center>
...
from os import path
order_statetxt = open(path1+'/bitmex_trading_bot/outputfile.txt', 'r')
...
scp.put('/home/q/web/web.html', recursive=True, remote_path='~/public_html/eth.html')
